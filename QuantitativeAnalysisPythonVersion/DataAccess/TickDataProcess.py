...
class TickDataProcess(object):
    ...
    def getResampleTickShotDataFromInfluxdbServer(self,code,date):
        ...
        data=result[measurement]
        data=pd.DataFrame(data)
        renameDict={'HighLimit':'highLimit', 'LowLimit':'lowLimit', 'OPNPRC':'dailyOpen', 'PRECLOSE':'dailyPreClose', 'TradeStatus':'tradeStatus', 'cp':'lastPrice', 'stkcd':'code', 'tdate':'date','tick':'influxdbTime', 'ts':'volume', 'tt':'amount',
