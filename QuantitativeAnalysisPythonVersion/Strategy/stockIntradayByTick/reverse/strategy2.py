...
class strategy1(object):
    ...
    def singleCode(self,code,startDate,endDate,parameters):
        ...
        select=['code','date','tick','B1','S1','midIncreasePrevious3m','closeStd20','ts_closeStd20','ts_buySellForceChange','ts_buySellVolumeRatio5','ts_buySellVolumeRatio2','differenceMidVwap','preClose','increaseToday','weight300','weight500']
        trade=[]
        for day in days:
